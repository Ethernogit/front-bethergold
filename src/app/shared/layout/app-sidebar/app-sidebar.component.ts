...
export class AppSidebarComponent {
    ...
    navItems: NavItem[] = [
        ...
        {
            icon: `<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M4 8a1 1 0 011-1h14a1 1 0 110 2H5a1 1 0 01-1-1zm1 4a1 1 0 100 2h14a1 1 0 100-2H5zm1 6a1 1 0 110-2h14a1 1 0 110 2H6z" fill="currentColor"/></svg>`,
            name: "Ventas / POS",
            path: "/sales/new",
            permission: 'sales:create'
        },
        {
            icon: `<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M8 3C8 3.55228 8.44772 4 9 4H15C15.5523 4 16 3.55228 16 3H19C19.5523 3 20 3.44772 20 4V20C20 20.5523 19.5523 21 19 21H5C4.44772 21 4 20.5523 4 20V4C4 3.44772 4.44772 3 5 3H8ZM6 6H18V19H6V6ZM10 2C9.44772 2 9 2.44772 9 3H15C15 2.44772 14.5523 2 14 2H10Z" fill="currentColor"/><path d="M8 9H16V10H8V9Z" fill="currentColor"/><path d="M8 12H16V13H8V12Z" fill="currentColor"/><path d="M8 15H13V16H8V15Z" fill="currentColor"/></svg>`,
            name: "Notas",
            path: "/sales/history",
        ...
        {
            icon: `<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M3 5C3 3.89543 3.89543 3 5 3H19C20.1046 3 21 3.89543 21 5V19C21 20.1046 20.1046 21 19 21H5C3.89543 21 3 20.1046 3 19V5ZM5 5H19V7H5V5ZM5 9H19V19H5V9ZM7 11H9V13H7V11ZM7 15H9V17H7V15ZM11 11H13V13H11V11ZM11 15H13V17H11V15ZM15 11H17V13H15V11ZM15 15H17V17H15V15Z" fill="currentColor"/></svg>`,
            name: "Reportes",
            path: "/reportes",
    ...
    othersItems: NavItem[] = [
        /*  {
         ...
         },
         {
           ...
           name: "Authentication",
           subItems: [
             { name: "Sign In", path: "/signin", pro: true },
             { name: "Sign Up", path: "/signup", pro: false },
           ],
         }, */
        {
            icon: `<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12 15.5A3.5 3.5 0 0 1 8.5 12A3.5 3.5 0 0 1 12 8.5a3.5 3.5 0 0 1 3.5 3.5a3.5 3.5 0 0 1-3.5 3.5m7.43-2.53c.04-.32.07-.64.07-.97c0-.33-.03-.66-.07-1l2.11-1.63c.19-.15.24-.42.12-.64l-2-3.46c-.12-.22-.39-.31-.61-.22l-2.49 1c-.52-.39-1.06-.73-1.69-.98l-.37-2.65A.506.506 0 0 0 14 2h-4c-.25 0-.46.18-.5.42l-.37 2.65c-.63.25-1.17.59-1.69.98l-2.49-1c-.22-.09-.49 0-.61.22l-2 3.46c-.13.22-.07.49-.12-.64L4.57 11c-.04.34-.07.67-.07 1c0 .33.03.65.07.97l-2.11 1.66c-.19.15-.25.42-.12.64l2 3.46c.12.22.39.3.61.22l2.49-1.01c.52.4 1.06.74 1.69.99l.37 2.65c.04.24.25.42.5.42h4c.25 0 .46-.18.5-.42l.37-2.65c.63-.26 1.17-.59 1.69-.99l2.49 1.01c.22.08.49 0 .61-.22l2-3.46c.12-.22.07-.49-.12-.64l-2.11-1.66Z" fill="currentColor"></path></svg>`,
        ...
        },
        {
            ...
            subItems: [
                ...
                { name: "Reglas de Precio", path: "/settings/pricing-rules", permission: 'organization:update' }
            ]
        },
        {
    ...
    onSidebarClick(event: MouseEvent) {
        const target = event.target as HTMLElement;
        // Check if the click is on an interactive element or inside one
        const interactive = target.closest('a, button, input, .menu-item, app-user-dropdown');

        if (!interactive) {
            // It's a click on empty space, expand the sidebar if collapsed
